...
**Algorithm**
1. create return variable and set to input string split or empty array
2. use map to transform the array
  - for each element return word + ' ' + word.length
3. return array
*/

function wordLengths(str) {
  let words = str !== undefined ? str.split(' ') : [];
