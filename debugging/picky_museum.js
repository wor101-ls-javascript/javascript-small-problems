function wantToVisit(museum, city) {
  return (museum.includes('Computer') || museum.includes('Science')) || (museum.includes('Andy Warhol') && museum.includes('Modern') && museum.includes('Art')) || (museum.includes('Modern') && museum.includes('Art') && city.includes('Amsterdam'));
    // museum.includes('Computer') || museum.includes('Science') && !(museum.includes('Modern') && museum.includes('Art') && museum.includes('Andy Warhol') || city === 'Amsterdam'      );
}
